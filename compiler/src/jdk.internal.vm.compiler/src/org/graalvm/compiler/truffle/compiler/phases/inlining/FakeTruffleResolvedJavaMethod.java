...
public class FakeTruffleResolvedJavaMethod implements ResolvedJavaMethod {
    ...
    public FakeTruffleResolvedJavaMethod(AlternativeBytecodeProxy bytecode, KnownTruffleTypes types) {
        this.bytecode = bytecode;
        this.constantPool = new AlternativeBytecodeConstantPool(bytecode.getConstantPool(), types);
        this.types = types;
    }
    ...
    public ProfilingInfo getProfilingInfo(boolean includeNormal, boolean includeOSR) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getProfilingInfo'");
    }
